...
function registrationCheck (date_1, date_2){
    let user = users.filter((reg) => reg.registrationDate == date_1 || reg.registrationDate == date_2);
    console.log(user);
}

registrationCheck('09.10.2021','10.10.2021');